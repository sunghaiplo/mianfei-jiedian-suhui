...
> An iPhone-friendly entry point for readers who mainly use Shadowrocket or Stash and want the latest article first.
...
请打开上面的博客文章，在正文“免费订阅地址”区域获取当天可用入口。移动端容易复制错内容，所以把真实地址放在正文更不容易出错。
...
- 内容重点：Shadowrocket 订阅、iOS VPN 权限、移动网络切换和复制排错；2026年9月22日更新；香港、日本、新加坡、美国 等地区；100 Mbps 公共限速
...
- Shadowrocket 用户建议优先核对系统 VPN 权限和订阅导入步骤。
...
本站每日北京时间 00:00 自动处理免费节点用户：重置流量、刷新订阅 Token、写入服务端动态数据，并同步 GitHub 分享仓库。Shadowrocket 用户建议优先核对系统 VPN 权限和订阅导入步骤。 仓库里的 `sub/latest.txt` 只保存当天文章链接，不保存真实订阅地址。
